...
def make_b_deformer(cfg):
    module = cfg.tpose_deformer.module
    deformer = importlib.import_module(module).Deformer(deformer_cfg=cfg.tpose_deformer)
    return deformer

def make_f_deformer(cfg):
    module = cfg.fpose_deformer.module
    deformer = importlib.import_module(module).Deformer(deformer_cfg=cfg.fpose_deformer)
    return deformer
